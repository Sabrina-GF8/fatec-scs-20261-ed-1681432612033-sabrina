...
* Objetivo: Mostrar na prática os conceitos de            *
* listas ligadas em python                                *
*                  Data: 09/03/2026                       *
*---------------------------------------------------------*
'''
...
def inserirMeio(listaEntrada):
    ...
    referencia = input("Deseja inserir depois de qual valor? ")
...
def remover(listaEntrada):
    ...
    argumentoPesquisa = input("Informe o valor que deseja remover: ")
